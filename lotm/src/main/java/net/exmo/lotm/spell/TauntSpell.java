...
public final class TauntSpell extends InstantLotmSpell {
    public TauntSpell() {
        super("taunt", SchoolRegistry.FIRE_RESOURCE, 15, 15);
    }
    ...
    protected void cast(Level level, int spellLevel, LivingEntity caster) {
        ...
        LotmRuntime.taunt(caster, target);
    }

    @Override
    public List<MutableComponent> getUniqueInfo(int spellLevel, LivingEntity caster) {
        return List.of(Component.translatable("spell.lotm.taunt.guide"));
    }
}
