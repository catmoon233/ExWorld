...
public final class ChainLightningModifier implements GunModifier {
    ...
    public void apply(ShotComponentMap components) {
        ...
        components.getOrCreate(ShotComponents.MUZZLE_FLASH).addTint(new Vector3f(((MUZZLE_FLASH_COLOR >> 16) & 255) / 255f, ((MUZZLE_FLASH_COLOR >> 8) & 255) / 255f, (MUZZLE_FLASH_COLOR & 255) / 255f));
    }
