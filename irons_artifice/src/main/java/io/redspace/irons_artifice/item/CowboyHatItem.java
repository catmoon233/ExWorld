...
public class CowboyHatItem extends ArmorItem implements GeoItem {
    public static final Holder<ArmorMaterial> COWBOY_HAT_MATERIAL = Holder.direct(new ArmorMaterial(
            ...
            List.of(new ArmorMaterial.Layer(IronsArtifice.id("cowboy_hat"))),
            0.0F,
            0.0F
    ));
    ...
    public CowboyHatItem(Properties properties) {
        super(COWBOY_HAT_MATERIAL, ArmorItem.Type.HELMET, properties.durability(ArmorItem.Type.HELMET.getDurability(37)));
